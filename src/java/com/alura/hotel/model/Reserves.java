...
public class Reserves {
	...
	public Integer createReserve(Integer huespedId, String fechaEntrada, String fechaSalida, String valor,
		...
		String statement = "INSERT INTO reservas (huesped_id, fechaEntrada, fechaSalida, valor,"
				+ "formaPago) VALUES (?, ?, ?, ?, ?)";
	...
	public void readReserve(Integer id) throws SQLException {
		//Another case if need to add try/catch
	...
	public void updateReserve(Integer id, Integer huespedId, String fechaEntrada, String fechaSalida,
			String valor,	String formaPago) throws SQLException {
		
		String statement = "UPDATE reservas SET huesped_id = ?, fechaEntrada = ?, fechaSalida = ?,"
