...
public class RegistroHuespedNuevo extends JFrame {
	...
	public RegistroHuespedNuevo(final RegistroReserva reservas) {
		...
		JLabel lblTitulo = new JLabel("REGISTRO DE NUEVO HUESPED");
		...
		txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuespedNuevo.class.getResource("/imagenes/icon-reservas.png")));
